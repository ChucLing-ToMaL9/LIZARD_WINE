...
import com.example.lizardswine.Model.DangNhap
...
fun DangNhap(navHostController: NavHostController) {
    ...
    {innerPadding ->
        Column(
            ...
            Text("Tên đăng nhập", fontSize = 14.sp, color = Color(0xFF188158), fontWeight = FontWeight.Bold)
            ...
            Text("Mật khẩu", fontSize = 14.sp, color = Color(0xFF188158), fontWeight = FontWeight.Bold)
            Spacer(modifier = Modifier.height(8.dp))
            OutlinedTextField(
                value = password,
